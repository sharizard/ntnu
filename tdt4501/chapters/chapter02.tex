...
\label{sub:software_development_life_cycles}
...
% subsection software_evolution (end)

% subsection software_development_life_cycles (end)
% subsection  (end)