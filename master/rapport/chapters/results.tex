...
% In addition to the traditional metrics, we have also gathered data using object-oriented metrics. Traditional software metrics are important for identifying large and complex files, but they alone may not tell us why some classes are large and complex. 
...
\resizebox{\textwidth}{!}{
\centering
\caption{Object-oriented metrics and descriptive statistics for Project "Firmus"}
...
\resizebox{\textwidth}{!}{
\centering
\caption{Object-oriented metrics and descriptive statistics for Component A}
...
\resizebox{\textwidth}{!}{
\centering
\caption{Object-oriented metrics and descriptive statistics for Component B}
...
\resizebox{\textwidth}{!}{
\centering
\caption{Object-oriented metrics and descriptive statistics for Component C}
...
\resizebox{\textwidth}{!}{
\centering
\caption{Object-oriented metrics and descriptive statistics for Component Ex}
...
\resizebox{\textwidth}{!}{
\centering
\caption{Object-oriented metrics and descriptive statistics for Component G}
...
\resizebox{\textwidth}{!}{
\centering
\caption{Object-oriented metrics and descriptive statistics for Component L}
...
\resizebox{\textwidth}{!}{
\centering
\caption{Object-oriented metrics and descriptive statistics for Component N}
...
\resizebox{\textwidth}{!}{
\centering
\caption{Object-oriented metrics and descriptive statistics for Component P}
...
\resizebox{\textwidth}{!}{
\centering
\caption{Object-oriented metrics and descriptive statistics for Component S}
\label{tab:oometrics-sys}
\begin{tabular}{|l|l|l|l|l|l|l|l|}
\hline
\textbf{Metric} & \textbf{Min} & \textbf{Max} & \textbf{Median} & \textbf{Sample Mean} & \textbf{Standard Deviation} & \textbf{Kurtosis} & \textbf{Skewness} \\ \hline
LCOM            & 33           & 50           & 41.5            & 41.5                 & 12.021   & N/A & -0.472                     \\ \hline
DIT             & 0            & 1            & 0.5             & 0.5                  & 0.707     & N/A  & -0.472                    \\ \hline
CBO             & 3            & 7            & 5             & 5                  & 2.829         & N/A  & -0.472                \\ \hline
NOC             & 0            & 0            & 0               & 0                    & 0         & N/A  & -0.472                    \\ \hline
